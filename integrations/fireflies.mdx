...
<Card title="Connect Fireflies" icon="plug" href="https://app.hearflow.io/settings/integrations">
...
<Steps>
  ...
  <Step title="Open Hearflow integrations">
    In Hearflow, go to [Settings → Integrations](https://app.hearflow.io/settings) and select **Fireflies**.
  </Step>
...
<Steps>
  <Step title="In Hearflow">
    Navigate to [Settings → Integrations](https://app.hearflow.io/settings) and click **Disconnect** next to Fireflies. This deletes the stored API key and stops all future syncs.
  </Step>
