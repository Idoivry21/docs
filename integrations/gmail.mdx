...
<Card title="Connect Gmail" icon="plug" href="https://app.hearflow.io/settings/integrations">
...
<Steps>
  <Step title="Open Hearflow integrations">
    Navigate to [Settings → Integrations](https://app.hearflow.io/settings) and choose Gmail.
  </Step>
