...
**Examples**: Billing, Onboarding, Reporting, API, Integrations. To configure product areas, go to [Settings → Product Areas](https://hearflow.io/settings).
...
<AccordionGroup>
  <Accordion title="No Insights Appearing">
    1. Verify integrations are connected in [Settings → Integrations](https://hearflow.io/settings/integrations)
    2. Check that calls have been processed in [Dashboard → Processing](https://hearflow.io/dashboard)
...
<Card title="Ready to get started?" icon="sparkles" href="https://hearflow.io/settings/integrations" horizontal>
